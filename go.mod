module github.com/skeletongo/game-stack

go 1.25.0

require (
	github.com/dobyte/due/locate/redis/v2 v2.0.0-20260423084221-f9caf382108e
	github.com/dobyte/due/network/ws/v2 v2.0.0-20260423084221-f9caf382108e
